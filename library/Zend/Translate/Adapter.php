...
abstract class Zend_Translate_Adapter {
    ...
    public function setLocale($locale)
    {
        ...
        if(empty($this->_translate[$locale])){
            if(isset($this->_options['fallback_locale']) && !empty($this->_options['fallback_locale'])){
                $locale=(string)$this->_options['fallback_locale'];
            }
        }
    ...
    public function translate($messageId, $locale = null)
    {
        ...
        // if a translation is not found for the requested language then try the fallback language
