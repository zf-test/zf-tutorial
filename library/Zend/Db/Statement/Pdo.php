...
class Zend_Db_Statement_Pdo extends Zend_Db_Statement implements IteratorAggregate
{
     ...
     * @throws Zend_Db_Statement_Exception
     */
    public function fetch($style = null, $cursor = null, $offset = null,$className='stdClass')
    {
        if ($style === null) {
     ...
     * @throws Zend_Db_Statement_Exception
     */
    public function fetchAll($style = null, $col = null,$className='stdClass')
    {
        if ($style === null) {
            $style = $this->_fetchMode;
        }
        try {
            ...
            }else if($style==PDO::FETCH_CLASS){
                return $this->_stmt->fetchAll($style,$className);
            }else {
