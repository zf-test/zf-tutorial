...
abstract class Zend_Db_Adapter_Pdo_Abstract extends Zend_Db_Adapter_Abstract
{
    ...
    protected function _connect()
    {
        ...
        $this->_config['driver_options'][PDO::ATTR_TIMEOUT] = 2;
        // always use exceptions.
        $this->_config['driver_options'][PDO::ATTR_ERRMODE] = PDO::ERRMODE_EXCEPTION;
    ...
    public function closeConnection()
    {
        ...
        MysqlAdaptorHolder::getInstance()->deleteAdaptor($this) ;
    }
