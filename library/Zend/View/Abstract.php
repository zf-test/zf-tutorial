...
abstract class Zend_View_Abstract implements Zend_View_Interface
{
    ...
    public static function addDebugMessage($section,$key,$val){
            self::$debug_info[$section][$key]=$val;
    }
    ...
    {
        if(APPLICATION_ENV!='production')Zend_View::addDebugMessage('views',$name,true);
